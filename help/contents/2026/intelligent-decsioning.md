---
title: 通过智能决策提供实时客户体验
description: 了解如何使用Adobe Journey Optimizer进行智能决策并实时提供个性化的客户体验。
...
组织可以取得有影响力的成果，如提高客户参与度、提高转化率以及跨渠道无缝扩展。 以下嵌入的视频提供了这些概念的详细演练，并演示Adobe Journey Optimizer如何促进智能决策。
